...
// check user with the salt
  $salt_stmt = $dbconn->prepare('SELECT salt FROM user_secure WHERE username=:username');
  ...
  $login_stmt = $dbconn->prepare('Select username, uid FROM user_secure WHERE username=:username AND password=:pass');
